...
const App = () => {
  ...
  about: {
    paragraphs: [
      "Hey there! I'm Abhishek Kumar Pundir, a Computer Science student at Lovely Professional University, passionate about AI, ML, and full-stack development. I've been coding for over a year now, and I love turning creative ideas into impactful digital projects.",
      "I’m from India and spend most of my time learning, experimenting, and building cool stuff — from games and websites to AI projects. Outside tech, I enjoy reading books, cooking, and going for early morning runs. I’m currently focused on becoming an AI/ML Developer at SpaceX — that’s the dream!"
    ]
  },
  experiences: {
    paragraphs: [
      "I've built multiple real-world projects, including games like tic-tac-toe, snake, and memory card games, as well as various clone websites like Amazon and my personal anime/movie streaming site. I've also worked on advanced JavaScript projects that integrate APIs and animations with Tailwind CSS.",
      "Currently, I’m diving deep into the MERN stack for full-stack development and exploring AI/ML — combining both to create intelligent, interactive experiences. I’ve also learned to use AI tools like ChatGPT, Claude, and GitHub Copilot to speed up development while still maintaining strong problem-solving and logic-building skills."
    ]
  },
  recommended: {
    paragraphs: [
      "One book that truly shaped my mindset is 'The Laws of Human Nature' by Robert Greene. It helped me understand human behavior, motivation, and self-awareness — lessons that go far beyond tech or academics.",
      "For any aspiring developer, I’d say: focus on consistency and curiosity. Keep building, keep learning, and let your projects speak louder than your words. Growth isn’t about perfection — it’s about progress."
    ]
  }
};
  ...
  const handleTabClick = (tab) => {
    if (tab === activeTab) {
      setShowBlackShadow(true);
    } else {
      setActiveTab(tab);
      setShowBlackShadow(false);
    }
  };
          ...
          <div className="bg-[#363C43] rounded-[18px] relative" style={{
            ...
            <div className="p-6 pl-20">
              ...
              <div className="relative">
                <div className="max-h-[175px] overflow-y-scroll pr-3 space-y-3 scrollbar-custom">
                  {tabContent[activeTab].paragraphs.map((paragraph, index) => (
                    <p key={index} className="text-[#969696] leading-[1.6] text-[20px]">
                      {paragraph}
                    </p>
                  ))}
                </div>
                <style jsx>{`
                  ...
                  .scrollbar-custom::-webkit-scrollbar-thumb {
                    background: linear-gradient(to bottom, #4A4E54 0%, #4A4E54 75%, #3F4247 100%);
                    border-radius: 10px;
                  }
                  .scrollbar-custom::-webkit-scrollbar-thumb:hover {
                    background: linear-gradient(to bottom, #5A5E64 0%, #5A5E64 75%, #4F5257 100%);
                  }
                `}</style>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-6">
                  <button 
                    ...
                    className="relative px-5 py-3 bg-[#FFFFFF08] rounded-full text-[13px] font-semibold flex items-center gap-2 transition-all" style={{
                  ...
                  <div className="flex gap-3">
                    <button 
                      ...
                      className="w-11 h-11 rounded-full flex items-center justify-center transition-all duration-400 ease-in-out"
                      style={{
